...
export const SITE = {
  ...
  introKisa: "Salonlarını gör. Sonra içlerinde kimin olduğunu.",
  intro:
...
export const BOLUM = {
  ...
  kapsam: { eyebrow: "Kapsam",
            h2: "Salonlarını gör. Sonra içlerinde kimin olduğunu." },
