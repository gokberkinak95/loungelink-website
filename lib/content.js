...
export const SITE = {
  ...
  // ══════════════════════════════════════════════════════════════
  // 🔴 v0.43 — BİR YAZIM DENEMESİ GERİ ALINDI. DERS BURADA DURSUN.
  //
  // Kahramanı "Lounge kapısında öğrenilmez. Kalkıştan önce bilinir."
  // diye değiştirmiştim. Gerekçem teknik olarak sağlamdı (rakiple
  // aynı cümleyi kurmayalım, marka belgesinin ürün cümlesini öne
  // alalım) ama SONUÇ YANLIŞTI. Gökberk: "çok mekanik bir dil.
  // Bizim bir ruhumuz olması ve bunu hissettirmemiz lazım."
  //
  // Haklıydı. "Sessiz kesinlik" (MARKA_SISTEMI §2) SOĞUKLUK DEĞİL.
  // Kesinlik güven verir; ısı ise insanı yaklaştırır. Ben ikincisini
  // birincisi için feda etmişim — ve bu üründe yanlış takas, çünkü
  // satılan şey bir hesap makinesi değil, YANINDAKİ KOLTUK.
  //
  // 🆕 SINIF: **"BİR CÜMLEYİ RAKİPTEN AYRIŞTIRMAK İÇİN SOĞUTURSAN,
  // AYRIŞMIŞ AMA KİMSENİN İSTEMEDİĞİ BİR ŞEY ELDE EDERSİN.
  // FARKLILIK, ISININ YERİNE GEÇMEZ — ISIYA EKLENİR."**
  //
  // Ve rakiple aynı fikri paylaşmakta bir sakınca yok: "connecting
  // flights, connecting travelers" doğru bir fikir. Bizim kendi
  // cümlemiz zaten daha iyisini söylüyor ve sitede vardı, ama
  // altta, görünmez bir yerde: "Aktarma uçuşları bağlar. Biz
  // yolcuları." Artık kahramanın yanında duruyor.
  // ══════════════════════════════════════════════════════════════
  hero: "Senin uçağında, lounge'da yeri olan biri var.",
  heroLead: "Senin uçağında,",
  heroEm: "lounge'da yeri olan biri var.",
  heroEyebrow: "Salon hakkı cüzdanı",
  // Rakibin fikri, bizim cümlemizle. Kahramanın hemen altında.
  ...
  // 🔴 v0.43 — ESKİ METNİN RUHU KORUNDU, RİTMİ AÇILDI.
  // Eskisi tek nefeste 47 kelimeydi; ikinci virgülden sonrası
  // okunmuyordu. Kelimeleri değil, NOKTALARI değiştirdim: aynı
  // hikâye, dört nefes. Son cümle hâlâ host'a bakıyor, çünkü ilk
  // ekranda kazancını görmeyen host aşağı inmiyor.
  heroSub:
    "Her uçuşta biri yalnız bekliyor. Ve aynı terminalde, kartında " +
    "kullanılmayan bir misafir hakkı olan biri oturuyor. LoungeLink " +
    "ikisini aynı salonda buluşturur — aynı uçuşta, kalkıştan önce. " +
    "Ağırlayan da kazanır: bir kez ağırla, hakkın olmayan bir salonda " +
    "sen misafir ol.",
...
export const FLOW = [
  { n: "01", t: "Uçuşunu yaz", d: "Havalimanı, tarih, uçuş numarası. Host'san ilanını aç; misafirsen seyahatini ekle. Uçuş numarası isteğe bağlı — girmeyeni dışarıda bırakmayız." },
