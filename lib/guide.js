...
// aynı taşıyıcıda olması gerekiyor. Bu cümle olmadan rehber eksik.
export const CARRIER_RULE =
  "Misafirin de aynı taşıyıcıyla uçuyor olmalı — kural motoru bunu " +
...
const CARD_RULES = {
  ...
  "priority-pass": {
    label: "Priority Pass",
    verdict: "paid",
    title: "Anlaşmalı salonlarda girersin",
    body: "Priority Pass, programa dahil salonlarda geçerlidir. Hiçbir üyelik planında misafir ücretsiz dahil değil; ücret senin kartından çekilir — tutarı önceden gösteriyoruz.",
    warn: null,
  },
};
